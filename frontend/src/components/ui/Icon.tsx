...
export function Icon({ name, className = 'h-5 w-5' }: IconProps) {
  ...
  switch (name) {
    ...
    case 'history':
      return (
        <svg {...props}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6m6 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0h6m6 0v-4a2 2 0 00-2-2h-2a2 2 0 00-2 2v4m6 0h-6" />
        </svg>
      )
    case 'favorites':
      return (
    ...
    case 'logo':
      return (
        <svg {...props} viewBox="0 0 24 24">
          ...
          />
          <circle cx="12" cy="12" r="9" strokeWidth={1.25} opacity={0.35} />
        </svg>
      )
    case 'shield':
      return (
